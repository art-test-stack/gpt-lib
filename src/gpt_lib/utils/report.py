...
Number of Parameters: {human_format(num_parameters)}
...
Generated by GPT-Lib
"""


class ReportLogger:
    def __init__(self, report_template=header_template):
        self.report_template = report_template

    def log(self, **kwargs):
        report = self.report_template.format(**kwargs)
        print(report)
...
# Based on https://github.com/karpathy/nanochat/blob/master/nanochat/report.py
